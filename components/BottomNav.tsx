...
import { HomeIcon, UsersIcon, CalendarIcon, ClipboardListIcon, PaperAirplaneIcon, ShoppingCartIcon, UserCircleIcon } from './icons';
...
const BottomNav: React.FC<BottomNavProps> = ({ currentPage, setCurrentPage }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-slate-800/80 backdrop-blur-sm border-t border-slate-700 flex justify-around">
